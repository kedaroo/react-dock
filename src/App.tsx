...
function App() {
  const [widthArray, setScaleValue] = useState<number[]>(() => new Array(EL_COUNT).fill(48));
  ...
  const throttledMouseMoveHandler = throttle((e: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
    handleMouseMove(e)
  }, 10);
  ...
  return (
    <div className="wrapper">
      <div
        ...
        className="con"
      >
        {new Array(EL_COUNT).fill("").map((c, idx) => (
          <Item 
            key={idx} 
            index={idx} 
